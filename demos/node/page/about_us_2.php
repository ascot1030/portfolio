...
<h1 class="template-page-header"><span>About Us</span></h1><h3 class="template-page-subheader">Welcome to NODE a web design company with real experience<span>We are passionate about design and people</span></h3>			<!-- Features list -->	
