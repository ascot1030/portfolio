...
<h1 class="template-page-header"><span>Our Team</span></h1><h3 class="template-page-subheader">We use the potential of our experienced and creative experts<span>Meet the energetic members of our team</span></h3>			<!-- Team layout 25x25x25x25% -->
			<ul class="template-layout-25x25x25x25 template-reset-list template-clear-fix template-team-list template-team-list-infobar">
				...
				<li class="template-layout-column-center-left">
					<h2 class="template-team-list-member-name"><a href="#!/team/member">S. Brennan</a></h2>
				...
				<li class="template-layout-column-right">
					<h2 class="template-team-list-member-name"><a href="#!/team/member">C. Gaston</a></h2>
			...
			<ul class="template-layout-25x25x25x25 template-reset-list template-clear-fix template-team-list">
				...
				<li class="template-layout-column-left">
					<div class="template-image">
						...
						<div class="template-image-box-bottom">
							<div class="template-image-box-bottom-title"><a href="#!/team/member">Patricia Carl</a></div>
							<div class="template-image-box-bottom-subtitle">Training manager</div>
						</div>
						<div class="template-image-box-hover template-vertical-center">
							<a href="#" class="template-image-box-hover-link-popup" title="Open image"></a>
							<a href="#!/team/member" class="template-image-box-hover-link-more" title="Open details"></a>
							<div class="template-image-box-hover-title"><a href="#!/team/member">Patricia Carl</a></div>
				...
				<li class="template-layout-column-center-left">
					<div class="template-image">
						...
						<div class="template-image-box-bottom">
							<div class="template-image-box-bottom-title"><a href="#!/team/member">Regina Jones</a></div>
							<div class="template-image-box-bottom-subtitle">Flight engineer</div>
						</div>
						<div class="template-image-box-hover template-vertical-center">
							<a href="#" class="template-image-box-hover-link-popup" title="Open image"></a>
							<a href="#!/team/member" class="template-image-box-hover-link-more" title="Open details"></a>
							<div class="template-image-box-hover-title"><a href="#!/team/member">Regina Jones</a></div>
				...
				<li class="template-layout-column-center-right">
					<div class="template-image">
						...
						<div class="template-image-box-bottom">
							<div class="template-image-box-bottom-title"><a href="#!/team/member">Kristy Bryan</a></div>
							<div class="template-image-box-bottom-subtitle">Cab driver</div>
						</div>
						<div class="template-image-box-hover template-vertical-center">
							<a href="#" class="template-image-box-hover-link-popup" title="Open image"></a>
							<a href="#!/team/member" class="template-image-box-hover-link-more" title="Open details"></a>
							<div class="template-image-box-hover-title"><a href="#!/team/member">Kristy Bryan</a></div>
				...
				<li class="template-layout-column-right">
					<div class="template-image">
						...
						<div class="template-image-box-bottom">
							<div class="template-image-box-bottom-title"><a href="#!/team/member">Zina Lucas</a></div>
							<div class="template-image-box-bottom-subtitle">Market manager</div>
						</div>
						<div class="template-image-box-hover template-vertical-center">
							<a href="#" class="template-image-box-hover-link-popup" title="Open image"></a>
							<a href="#!/team/member" class="template-image-box-hover-link-more" title="Open details"></a>
							<div class="template-image-box-hover-title"><a href="#!/team/member">Zina Lucas</a></div>
