...
<h1 class="template-page-header"><span>Portfolio 1 Column</span></h1><h3 class="template-page-subheader">Our portfolio features a variety of projects and services<span>Click the image you want to learn about</span></h3>			<!-- Portfolio list -->
				...
				<li class="template-layout-column-left">
					...
					<div class="template-image">
						...
						<div class="template-image-box-bottom">
							<div class="template-image-box-bottom-title"><a href="#!/portfolio/item">Buckeye Furniture</a></div>
						...
						<div class="template-image-box-hover template-vertical-center">
							...
							<!-- /Open image button -->
							<!-- Open details button -->
							<a href="#!/portfolio/item" class="template-image-box-hover-link-more" title="Open details"></a>
							<!-- /Open details button -->
							<!-- Title -->
							<div class="template-image-box-hover-title"><a href="#!/portfolio/item">Buckeye Furniture</a></div>
							<!-- /Title -->
							<!-- Subtitle -->
