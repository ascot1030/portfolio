...
<h1 class="template-page-header"><span>Team With Infobar</span></h1><h3 class="template-page-subheader">We use the potential of our experienced and creative experts<span>Meet the energetic members of our team</span></h3>			<!-- Complete description of HTML structure for team is located in file team_layout_2_column.php -->
			...
			<ul class="template-layout-25x25x25x25 template-reset-list template-clear-fix template-team-list template-team-list-infobar">
				...
				<li class="template-layout-column-center-left">
					<h2 class="template-team-list-member-name"><a href="#!/team/member">A. Powers</a></h2>
				...
				<li class="template-layout-column-right">
					<h2 class="template-team-list-member-name"><a href="#!/team/member">V. Wofford</a></h2>
